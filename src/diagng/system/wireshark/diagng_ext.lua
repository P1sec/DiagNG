--[[
    This is a GSMTAP v3 dissector for Wireshark, directly based
    on the GSMTAP v3 dissector from SCAT by Shinjo "peremen" Park:
        - https://github.com/fgsect/scat/commits/master/wireshark/scat.lua

    Credits go to him.

    Like DiagNG and SCAT, this dissector is put under the
    GNU GPL license.
--]]
