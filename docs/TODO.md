* Check for interesting XDG portals to use (using the ASHPD demo application, etc.)
...
* Eventually create a `diagng` daemon entry point that will handle all low-level tasks such as SPI communication, Diag data acquisition, etc.?
